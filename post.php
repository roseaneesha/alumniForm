...
if (isset($alumniFeedback)) {
    $req = json_decode($alumniFeedback);
    // var_dump($req);
    $stuName = mysqli_real_escape_string($connect, $req->stuName);

    $orgName
        = mysqli_real_escape_string($connect, $req->orgName);

    $organization
        =  implode(',', $req->organization);

    $qualifications
        =  implode(',', $req->quaifications);

    $email
        = mysqli_real_escape_string($connect, $req->email);

    $mobile
        = mysqli_real_escape_string($connect, $req->mobile);

    $regNum
        = mysqli_real_escape_string($connect, $req->regNum);
    ...
    $q14b
        = mysqli_real_escape_string($connect, $req->q14b);

    $q15
        = $req->q15;

    $q15b
        = mysqli_real_escape_string($connect, $req->q15b);
    ...
    $q18
        = mysqli_real_escape_string($connect, $req->q18);




    // $insertQuery = "INSERT INTO feedback (studentName,orgName, organization,qualification,email,mobile,regNum,q1,q2,q3,q4,q5,q6,q7,q8,q9,q10,q11,q12,q13,q14,q14b,q15,q15b,q16,q17,q18) VALUES ('$stuName','$orgName','$organization','$qualifications','$email','$mobile','$regNum','$q1','$q2','$q3','$q4','$q5','$q6','$q7','$q8','$q9','$q10','$q11','$q12','$q13','$q14','$q14b',$q15','$q16','$q17','$q18')";
